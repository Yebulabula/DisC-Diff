...
# SAMPLE_FLAGS="--batch_size 10 --num_samples 50000 --timestep_respacing 1000 --use_ddim False"
# mpiexec -n 2 python scripts/super_res_sample.py $MODEL_FLAGS $SAMPLE_FLAGS